...
export const places = [
  ...
  },
  {
    ...
    "description": "Africa's largest private art gallery, showcasing thousands of contemporary Nigerian artworks across four floors.",
  ...
  },
  {
    ...
    "address": "Tarkwa Bay Island (Accessible via boat from VI or CMS), Lagos",
    "description": "A serene, artificial sheltered beach located near the Lagos harbour, popular for water sports and swimming.",
    "image": "images/tarkwa-bay.webp"
  },
  {
    "name": "Kalakuta Museum",
    "address": "24 Gbemisola Street, Allen Avenue, Ikeja, Lagos",
    "description": "The former residence and final resting place of Afrobeat pioneer Fela Kuti, dedicated to his life and music.",
  ...
  },
  {
    ...
    "address": "Commerce House, 1, Idowu Taylor Street, Victoria Island, Lagos",
    "description": "A historic landmark representing the heartbeat of Lagos commerce and industrial advocacy.",
    "image": "images/lcci.webp"
  }
];